...
| **D8** 경계값 케이스 200건 · 금지어 사전 | **TC-NF-002 · TC-FUNC-009** (배포 게이트 2건 모두) |
...
**D8이 가장 급하다.** 배포 게이트 2건(TC-NF-002 · TC-FUNC-009)이 모두 D8에 막혀 있어, **경계값 케이스와 금지어 사전이 없으면 게이트를 구성할 수 없다.** C-TEC-007a를 확정한 의미가 사라진다.
