...
**근거 문서:** STD-CARDFIT-001 v1.0 (`[STD]cardfit-test-spec.md`)

**참조 문서:** SRS-CARDFIT-001 (`[SRS]cardfit-srs-v1_0.md`)
...
**D2·D5가 확정돼 260건 전건에 주입됐다.** 값의 정본은 `[CALC]cardfit-calc-spec.md`(CALC-CARDFIT-001) 1장이다.
