...
description: 태스크 이슈 하나를 착수 조건 점검부터 완료 판정까지 진행한다. 무엇부터 할지 고를 때와 태스크를 시작할 때 사용한다.
---
# 태스크 착수
...
| 성격 | 문서 |
| --- | --- |
| 계산·게이팅·조합·배분 | `docs/tech-design-docs/[CALC]cardfit-calc-spec.md` — **값의 정본** |
| 픽스처·어댑터·시드 | `docs/tech-design-docs/[FXT]cardfit-fixture-spec.md` |
| API·스키마·에러 코드 | `docs/tech-design-docs/[SRS]cardfit-srs-v1_0.md` §6 |
| 화면 | 대응 `DS-0N` 설계 태스크 |
| 테스트 | `docs/tech-design-docs/[STD]cardfit-test-spec.md` — **AC를 새로 만들지 않는다** |
